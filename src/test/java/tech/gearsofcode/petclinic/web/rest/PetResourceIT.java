...
class PetResourceIT {
    ...
    public static Pet createEntity(EntityManager em) {
        Pet pet = new Pet().name(DEFAULT_NAME).birthdate(DEFAULT_BIRTHDATE);
        return pet;
    }
    ...
    public static Pet createUpdatedEntity(EntityManager em) {
        Pet pet = new Pet().name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);
        return pet;
    }
    ...
    void createPet() throws Exception {
        ...
        assertThat(testPet.getBirthdate()).isEqualTo(DEFAULT_BIRTHDATE);
    }
    ...
    void putExistingPet() throws Exception {
        ...
        updatedPet.name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);
        ...
        assertThat(testPet.getBirthdate()).isEqualTo(UPDATED_BIRTHDATE);
    }
    ...
    void fullUpdatePetWithPatch() throws Exception {
        ...
        partialUpdatedPet.name(UPDATED_NAME).birthdate(UPDATED_BIRTHDATE);

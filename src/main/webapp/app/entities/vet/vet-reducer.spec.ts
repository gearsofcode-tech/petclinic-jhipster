...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VET_LIST actions', async () => {
    ...
    it('dispatches FETCH_VET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VET actions', async () => {
      const expectedActions = [
        {

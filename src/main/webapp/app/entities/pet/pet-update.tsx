  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="petclinicjhipsterApp.pet.home.createOrEditLabel" data-cy="PetCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Birthdate" id="pet-birthdate" name="birthdate" data-cy="birthdate" type="date" />
              <ValidatedField id="pet-type" name="type" data-cy="type" label="Type" type="select">
                <option value="" key="0" />
                {petTypes

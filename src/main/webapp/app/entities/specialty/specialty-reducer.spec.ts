...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './specialty.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALTY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPECIALTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALTY actions', async () => {
      const expectedActions = [
        {

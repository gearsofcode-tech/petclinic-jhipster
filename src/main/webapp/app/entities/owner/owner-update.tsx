  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="petclinicjhipsterApp.owner.home.createOrEditLabel" data-cy="OwnerCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Address" id="owner-address" name="address" data-cy="address" type="text" />
              <ValidatedField label="City" id="owner-city" name="city" data-cy="city" type="text" />
              <ValidatedField label="Telephone" id="owner-telephone" name="telephone" data-cy="telephone" type="text" />

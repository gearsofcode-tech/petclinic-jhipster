...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pet-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PETTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PETTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PETTYPE actions', async () => {
      const expectedActions = [
        {
